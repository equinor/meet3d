'use strict'; // import { newUserJoined, userGotMedia, changePos3D } from './3D.js';
...
exports.initSignaling = initSignaling;
exports.leaveRoom = leaveRoom;

var ThreeD = _interopRequireWildcard(require("./3D.js"));
...
var ourID; //const signalServer = 'signaling-server-meet3d-master.radix.equinor.com'; // The signaling server
...
function initSignaling(room, name, cons) {
  ...
  console.log('Attempting to join ' + room); // We created and joined a room
  ...
  socket.on('join', function (startInfo) {
    ...
    (0, _client.appendConnectionHTMLList)(startInfo.id);
